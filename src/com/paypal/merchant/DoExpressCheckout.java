...
public class DoExpressCheckout {
	...
	public DoExpressCheckoutPaymentResponseType doExpressCheckout(String payerId,String Token,BasicAmountType amount,String accountId) throws IOException {
...
//				"2.00");
		paymentDetails1.setOrderTotal(amount);
		...
		//sellerDetails1.setPayPalAccountID("reservas@peruandestop.com");
		sellerDetails1.setPayPalAccountID(accountId);
//		sellerDetails1.setPayPalAccountID("washi1886-facilitator@hotmail.com");
